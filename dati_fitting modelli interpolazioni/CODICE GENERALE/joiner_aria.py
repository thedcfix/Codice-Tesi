...
temp_data_stations = temp_data_stations.loc[temp_data_stations['NomeTipoSensore'] ==  'Particelle sospese PM2.5']

#temp_data = temp_data.loc[temp_data['DATE_TIME'] == '2016-11-14 11:00:00']
temp_data = temp_data.loc[temp_data['DATE_TIME'] == '2016-11-14']
